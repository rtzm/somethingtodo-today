...
final class Version20240414230225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prompt (id INT NOT NULL, text TEXT NOT NULL, use_date DATE DEFAULT NULL, created_timestamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_timestamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
    }
