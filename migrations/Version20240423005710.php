 ...
 */
final class Version20240423005710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX use_date_idx ON prompt (use_date)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX use_date_idx');
    }
}
